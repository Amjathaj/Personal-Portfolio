...
import { SiMysql } from "react-icons/si"; // For SQL (MySQL icon as a placeholder)
...
const Profile = () => {
  const skills = [
    ...
    { name: "Bootstrap", icon: DiBootstrap, color: "purple.600" },
  
  
    { name: "Chakra UI", icon: SiChakraui, color: "teal.400" },
 
    { name: "Material UI", icon: SiMui, color: "blue.700" },
    { name: "Python", icon: DiPython, color: "yellow.400" },
    { name: "SQL", icon: SiMysql, color: "blue.600" },
    { name: "Git", icon: DiGit, color: "red.500" },
